...
#define TEST_DATA_BIG_FLOATS                                                    \
    "---------------------- Testing complex floats ---------------------- \n"   \
    " 123456789123456789.111111111                   = %f\n"                    \
    "-123456789123456789.111111111                   = %f\n"                    \
    " 5555555555555555555555.5555555555              = %f\n"                    \
    " 1000000000000000000000.0000000000              = %f\n"                    \
    " 123456789123456789123456789123456789.111111111 = %f\n"                    \
    "-123456789123456789123456789123456789.111111111 = %f\n"                    \
    " 4242424242424242424242.42424242                = %f\n"                    \
    "-4242424242424242424242.42424242                = %f\n"                    \
    "-5252525252525252525252.52525252                = %f\n"                    \
    " 2**63                                          = %f\n"                    \
    "-2**63                                          = %f\n"                    \
    " 2**63 - 1                                      = %f\n"                    \
    " 2**63 - 5000                                   = %f\n"                    \
    "-------------------------------------------------------------------- \n",  \
     123456789123456789.111111111,                                              \
    -123456789123456789.111111111,                                              \
     5555555555555555555555.5555555555,                                         \
     1000000000000000000000.0000000000,                                         \
     123456789123456789123456789123456789.111111111,                            \
    -123456789123456789123456789123456789.111111111,                            \
     4242424242424242424242.42424242,                                           \
    -4242424242424242424242.42424242,                                           \
    -5252525252525252525252.52525252,                                           \
     pow(2, 63),                                                                \
    -pow(2, 63),                                                                \
     pow(2, 63) - 1,                                                            \
     pow(2, 63) - 5000
